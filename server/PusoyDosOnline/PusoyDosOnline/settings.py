"""
Django settings for PusoyDosOnline project.
...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', '.ngrok.io', '159.65.129.248']
...
ROOT_URLCONF = 'PusoyDosOnline.urls'
...
WSGI_APPLICATION = 'PusoyDosOnline.wsgi.application'
